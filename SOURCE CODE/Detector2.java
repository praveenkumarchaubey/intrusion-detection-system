...
/**
 * Summary description for Detector2
 *
 */
public class Detector2 extends JFrame
{
	...
	private void initializeComponent()
	{
		...
		// jLabel1
		//
		jLabel1.setText("INTRUSION DETECTOR2");
		//
		// jTextArea1
		//
		//
		...
		// Detector2
		//
		this.setTitle("Detector2 - extends JFrame");
...
public void server()
	{
						...
						if(destination.equalsIgnoreCase("R-103"))
							{
								jTextArea1.append("\t**********************************\n");
						...
						else if (destination.equalsIgnoreCase("R-104"))
						{
								jTextArea1.append("\t**********************************\n");
								jTextArea1.append("\tTHIS IS FROM PORT R_104\n");
								jTextArea1.append("\t**********************************\n");
								client_1=new Socket("localhost",102);
								dis1=new DataOutputStream(client_1.getOutputStream());
								dis1.writeInt(length);
						...
						else if (destination.equalsIgnoreCase("I-105"))
						{
								jTextArea1.append("\t**********************************\n");
								jTextArea1.append("\tTHIS IS FROM PORT I_105\n");
								jTextArea1.append("\t**********************************\n");
							...
							JOptionPane.showMessageDialog(null,"This Is Detected By Detector2!!!!!!");	
						}
