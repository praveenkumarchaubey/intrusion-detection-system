...
import java.net.*;
/**
 * Summary description for Sink2
 *
 */
public class Sink2 extends JFrame
{
	...
	private void initializeComponent()
	{
		...
		//
		// jTextArea1
		jTextArea1.setText("\t***********THIS IS FROM PORT R_103***********\n\n");
		//
		//
		// jScrollPane1
		//
		...
		//
		// jTextArea2
		jTextArea2.setText("\t**********THIS IS FROM PORT R_104***********\n\n");
		//
		//
		// jScrollPane2
		//
		...
		// Sink2
		//
		this.setTitle("Sink2 - extends JFrame");
